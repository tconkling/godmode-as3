 ...
 * tasks to operate on "entry accessors", which expose a single blackboard value, and are
 * created with "getEntryAccessor()" function.
 */
public class Blackboard
{
    /** Creates an accessor for the given key in the blackboard. */
    public function getEntryAccessor (key :String, defaultVal :* = undefined) :MutableEntry {
        return new BlackboardEntry(this, key, defaultVal);
    }
...
{
    public function BlackboardEntry (bb :Blackboard, key :String, defaultVal :*) {
        _bb = bb;
        _key = key;
